const DISPLAY_VALUE_MAP: Record<string, string> = {
  ...
  taker: "主动成交",
  unbound: "未绑定",
  unsupported_symbol: "当前不支持",
  unavailable: "当前不可申请",
  unhealthy: "异常",
  unknown: "未知",
  opening_order_gate: "开仓放行边界",
  operator_request: "人工操作请求",
  live_data_ready: "真实数据正常",
  protection_mode_active: "保护模式生效",
  runtime_symbols: "运行标的范围",
  runtime_status_missing: "运行状态缺失",
